...
public class ReturnFixBranch {
	...
	public ReturnFixBranch(MethodAnalysis methodAnalysis, ReturnFixBranch rb) {
		this(methodAnalysis);
	...
	public ReturnFixBranch(MethodAnalysis methodAnalysis) {
		this.methodAnalysis = methodAnalysis;
		
		initMethodInputArg();
	}
	
	public ReturnFixBranch split() {
		ReturnFixBranch splitrb = new ReturnFixBranch(methodAnalysis);
